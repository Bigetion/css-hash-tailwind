    ...
    <div className="mb-6 px-6 mx-auto lg:ml-0 lg:mr-auto xl:mx-0 xl:px-12">
      ...
      <PanelSection title="Include borders and padding" paddingless>
        <div className="relative grid grid-cols-3 grid-rows-3 gap-px bg-slate-700 bg-opacity-10 font-mono text-sm font-bold leading-6 max-w-sm mx-auto w-full shadow-xl">
          ...
          <div className="bg-white col-start-3 row-start-1" />
          <div className="relative bg-white col-start-1 row-start-2">
          ...
          <div className="bg-white col-start-2 row-start-2 w-32 h-32 ring-1 ring-sky-300">
            <div
          ...
          <div className="bg-white col-start-3 row-start-2" />
