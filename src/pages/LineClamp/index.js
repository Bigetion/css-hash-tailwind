  ...
  return (
    <div className="mb-6 px-6 mx-auto lg:ml-0 lg:mr-auto xl:mx-0 xl:px-12">
      ...
      <PanelSection title="Truncating multi-line text" paddingless>
        <article className="mx-auto max-w-sm bg-white p-8 text-sm leading-6 text-slate-700 shadow-xl sm:text-base sm:leading-7">
          <time
            dateTime="2020-03-16"
          ...
          <p className="line-clamp-3 mt-4 text-sm leading-6 text-slate-500">
          ...
          <div className="mt-4 flex gap-x-2.5 text-sm font-semibold leading-6 text-slate-900">
            <img
