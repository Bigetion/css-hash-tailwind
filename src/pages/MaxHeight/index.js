    ...
    <div className="mb-6 px-6 mx-auto lg:ml-0 lg:mr-auto xl:mx-0 xl:px-12">
      ...
      <PanelSection title="Setting the maximum height">
        <div className="flex justify-center items-end gap-3 sm:gap-4 font-mono font-bold text-xs text-center text-white whitespace-nowrap h-96">
          <div className={`h-full rounded-lg flex items-end ${stripes.blue}`}>
            <div className="w-8 bg-blue-500 rounded-lg shadow-lg h-full max-h-80 relative">
          ...
          <div className={`h-full rounded-lg flex items-end ${stripes.blue}`}>
            <div className="w-8 bg-blue-500 rounded-lg shadow-lg h-full max-h-64 relative">
              <div className="absolute w-8 bottom-6">
          ...
          <div className={`h-full rounded-lg flex items-end ${stripes.blue}`}>
            <div className="w-8 bg-blue-500 rounded-lg shadow-lg h-full max-h-48 relative">
              <div className="absolute w-8 bottom-6">
          ...
          <div className={`h-full rounded-lg flex items-end ${stripes.blue}`}>
            <div className="w-8 bg-blue-500 rounded-lg shadow-lg h-full max-h-40 relative">
              <div className="absolute w-8 bottom-6">
          ...
          <div className={`h-full rounded-lg flex items-end ${stripes.blue}`}>
            <div className="w-8 bg-blue-500 rounded-lg shadow-lg h-full max-h-32 relative">
              <div className="absolute w-8 bottom-6">
          ...
          <div className={`h-full rounded-lg flex items-end ${stripes.blue}`}>
            <div className="w-8 bg-blue-500 rounded-lg shadow-lg h-full max-h-24 relative">
              <div className="absolute w-8 bottom-6">
          ...
          <div className={`h-full rounded-lg flex items-end ${stripes.blue}`}>
            <div className="w-8 bg-blue-500 rounded-lg shadow-lg h-full max-h-full h-96 relative">
              <div className="absolute w-8 bottom-6">
